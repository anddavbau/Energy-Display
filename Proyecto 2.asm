...
; -- Variable para estado anterior del motor --
motor_estado_anterior equ h'31'
...
inicio:
    ...
    ; Inicializar estado del motor
    movlw   0x00
    movwf   motor_estado_anterior
...
MODO_INICIO:
    ...
    ; Completar el resto de la línea con espacios
    movlw   ' '
    call    datos
    movlw   ' '
    call    datos
...
;====================================================================
;       SUBRUTINA PARA CONTROLAR MOTOR
;====================================================================
controlar_motor:
    ; Verificar si el voltaje es >= 2.5V
    movlw   d'128'
    subwf   adc_resultado, W ; W = adc_resultado - 128
    
    ; Determinar acción basada en el resultado
    btfsc   STATUS, C   ; Saltar si C=0 (voltaje < 2.5V)
    goto    verificar_encender
    goto    verificar_apagar

verificar_encender:
    ; Verificar si ya estaba encendido
    movf    motor_estado_anterior, W
    xorlw   0x01
    btfsc   STATUS, Z
    return  ; Ya estaba encendido, no hacer nada
    
    ; Cambiar a estado encendido
    movlw   0x01
    movwf   motor_estado_anterior
...
verificar_apagar:
    ; Verificar si ya estaba apagado
    movf    motor_estado_anterior, W
    xorlw   0x00
    btfsc   STATUS, Z
    return  ; Ya estaba apagado, no hacer nada
...
;====================================================================
;       SUBRUTINA PARA MOSTRAR ESTADO DEL MOTOR (ON/OFF)
;====================================================================
mostrar_estado_motor:
    movlw   0xCD        ; Posición más a la derecha de la segunda línea
    call    comando
