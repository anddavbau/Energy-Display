...
inicio:
    ...
    ; Crear caracteres personalizados para batería
    call    crear_caracteres_bateria
    
    ; Inicializar estado anterior con un valor inválido para forzar primera transición
    movlw   0xFF
...
;====================================================================
;       SUBRUTINA PARA MOSTRAR VOLTAJE
;====================================================================
mostrar_voltaje:
...
crear_caracteres_bateria:
    ...
    call    datos
    movlw   B'00011111' ; Línea 7: -*---*-
    call    datos


    ; Carácter 1: Batería 25%
    movlw   0x50        ; Dirección CGRAM para carácter 1
    call    comando
    movlw   B'00001110'
    call    datos
    movlw   B'00011011'
    ...
    movlw   0x58        ; Dirección CGRAM para carácter 2
    call    comando
    movlw   B'00001110'
    call    datos
    movlw   B'00011011'
    ...
    movlw   0x60        ; Dirección CGRAM para carácter 3
    call    comando
    movlw   B'00001110'
    call    datos
    movlw   B'00011011'
    ...
    movlw   0x68        ; Dirección CGRAM para carácter 4
    call    comando
    movlw   B'00001110'
    call    datos
    movlw   B'00011111'
    ...
    movlw   0x70        ; Dirección CGRAM para carácter 0
    call    comando
    movlw   B'00001110' ; Línea 1: ___***_
    call    datos
    movlw   B'00011011' ; Línea 2: _**_**_
...
bat_0:
    movlw   0x06        ; Carácter personalizado 0
    call    datos
    movlw   ' '
    call    datos
    movlw   '0'
...
bat_25:
    movlw   0x02        ; Carácter personalizado 1
    call    datos
    movlw   ' '
    call    datos
    movlw   '2'
...
bat_50:
    movlw   0x03        ; Carácter personalizado 2
    call    datos
    movlw   ' '
    call    datos
    movlw   '5'
...
bat_75:
    movlw   0x04        ; Carácter personalizado 3
    call    datos
    movlw   ' '
    call    datos
    movlw   '7'
...
bat_100:
    movlw   0x05        ; Carácter personalizado 4
    call    datos
    movlw   ' '
    call    datos
    movlw   '1'
